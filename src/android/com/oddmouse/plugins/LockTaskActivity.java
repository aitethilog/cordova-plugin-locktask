...
public class LockTaskActivity extends CordovaActivity {
    ...
    protected void onStart() {
        super.onStart();
        System.out.println("LockTaskActivity started");
        running = true;
    }
    ...
    protected void onStop() {
        super.onStop();
        System.out.println("LockTaskActivity stopped");
        running = false;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // statusBarOverlay = StatusBarOverlay.createOrObtainPermission(this); // commenté pour avoir accès à notre header
    }
